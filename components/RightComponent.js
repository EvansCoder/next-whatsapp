...
function RightComponent() {
  return (
    <div className="flex flex-col w-screen h-screen justify-center items-center bg-dark-right">
      <svg
        width="360"
        viewBox="0 0 303 172"
        fill="none"
      ...
      <h1 className="text-light-gray text-4xl mt-20">WhatsApp Web</h1>
      <p className="text-light-gray text-base mt-2">Latest Build in progress</p>
    </div>
  );
}
